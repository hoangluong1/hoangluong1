...
<section class="shop-blog section">
	...
	<fieldset style="width: 850px; margin: auto; border: none;">
		<div class="menu-product-right" style="float:right;">
			<h3>Giá từ <?php echo number_format($fromPrice) ?> VNĐ đến <?php echo number_format($toPrice); ?></h3>
		</div>		
	</fieldset>
	...
	<div class="pagination">
		<div class="pagination-a">
			...
			<?php for($i = 1; $i <= $numPage; $i++): ?>
				<a href="index.php?controller=search&action=price&fromPrice=<?php echo $fromPrice ?>&toPrice=<?php echo $toPrice ?>&p=<?php echo $i; ?>">
					<?php echo $i; ?>
				</a>
			<?php endfor; ?>
		</div>
