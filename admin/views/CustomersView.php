...
?>
<div class="col-md-12">
    <h1 class="mt-4" style="text-align: center;">Customers</h1>
    <div style="margin-bottom:5px; float: right;">
        <a href="index.php?controller=users&action=create" class="btn btn-primary">Thêm khách hàng</a>
    </div>
        ...
        <div class="panel-body">
            ...
            <ul class="pagination">
                ...
                <?php for($i=1;$i<=$numPage;$i++): ?>
                    <li class="page-item">
                        <a href="index.php?controller=customers&p=<?php echo $i; ?>" class="page-link"><?php echo$i; ?></a>
                    </li>
                <?php endfor; ?>
            </ul>
        </div>
